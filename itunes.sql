...
/* =========================================================
   iTunes Music Analysis Project
   Database Setup
========================================================= */

-- Create and select the project database
CREATE DATABASE itunes_project;
USE itunes_project;
...
(201,'Judas 0 : B-Sides and Rataris',131),
(150,'Kill Em All',50),
(101,'Killers',90),
...
-- Album ↔ Artist relationship preview
...
/* ============================================================
   iTunes Music Store Analysis – SQL Business Insights
   Author: Laveena Majeed
...
/* ------------------------------------------------------------
   5. Country-wise Purchase & Revenue Analysis
   ------------------------------------------------------------ */
...
/* ------------------------------------------------------------
   6. Best Customer (Highest Spending)
   ------------------------------------------------------------ */
...
/* ------------------------------------------------------------
   8. Top Customer per Country (Using Window Function)
   ------------------------------------------------------------ */
...
/* ------------------------------------------------------------
   9. Customers Who Purchased Rock Genre
   ------------------------------------------------------------ */
...
/* ------------------------------------------------------------
   10. Top 10 Rock Artists by Track Count
   ------------------------------------------------------------ */
SELECT ar.name, 
...
/* ------------------------------------------------------------
   12. Most Popular Genre by Country
   ------------------------------------------------------------ */
WITH GenreCounts AS (
    SELECT 
        i.billing_country, 
...
/* ------------------------------------------------------------
   13. Top 10 Artists by Purchase Volume
   ------------------------------------------------------------ */
...
/* ------------------------------------------------------------
   15. Average Track Price by Genre
   ------------------------------------------------------------ */
...
SELECT 
    c.customer_id,
    SUM(i.total) AS spending,
    RANK() OVER (ORDER BY SUM(i.total) DESC) AS rank_spending
FROM customer c
JOIN invoice i ON c.customer_id = i.customer_id
